// threeHero.ts — floating tech objects for the hero (ported from the design).
// initHeroScene(canvas, { accent, accent2 }) -> returns dispose()
...
export function initHeroScene(
	...
	if (!canvas) return () => {};
	const accent = new THREE.Color(opts.accent || "#8b5cf6");
	const accent2 = new THREE.Color(opts.accent2 || "#6366f1");
